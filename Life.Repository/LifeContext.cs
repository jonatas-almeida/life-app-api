...
{
    public class LifeContext : IdentityDbContext<User, Role, int, IndentityUserClaim<int>, UserRole, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
